...
function yer(){
    ...
    document.getElementById("logo").setAttribute("src","canada.jpg")
   }
    ...
    document.getElementById("logo").setAttribute("src","amerika.jpg")
   }
    ...
    document.getElementById("logo").setAttribute("src","kulesi.jpg")
   }
   console.log(ulke)
}
function merhaba(){
